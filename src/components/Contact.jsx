const Contact = () => {
  return (
    <section className="min-h-screen bg-gradient-to-r from-cyan-500 to-teal-500 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
      <div className="container flex flex-col min-h-screen px-6 py-12 mx-auto">
        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
          ...
          <div className="mt-8 lg:w-1/2 lg:h-100 lg:mx-6">
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
              ...
              <form className="mt-4">
                ...
                <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize bg-gradient-to-r from-cyan-500 to-teal-500 rounded-md hover:bg-cyan-500 focus:outline-none focus:ring focus:ring-teal-500 focus:ring-opacity-50">
                  get in touch
                </button>
              </form>
            </div>
